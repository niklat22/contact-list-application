...
@NgModule({
  ...
  declarations: [ AppComponent, ContactComponent, ContactListComponent, AddContactComponent, SortComponent, EditContactComponent, ModalComponent, BackdropComponent  ],
